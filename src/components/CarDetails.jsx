...
const carData = [
  {
    ...
    price: 45,
    brand: 'Audi',
    other_images: ['https://unsplash.it/640/425?image=30', 'https://unsplash.it/640/425?image=40', 'https://unsplash.it/640/425?image=50'],
    transmission: 'Auto',
    fuel: 'Diesel',
    doors: '4',
  },
      ...
      {car && (
        <div className="details-class">
          ...
          <p style={{ width: '85%', fontSize: '16px', marginLeft: '2rem' }}>
            55 Car Rental LLC in Dubai offers an extensive selection of the latest model <span style={{ fontWeight: 'bold' }}>{car.name}</span> car available for self-drive rentals in Dubai. These luxury vehicles are perfect for special occasions, allowing you to experience the exhilaration of driving a supercar on the open roads of Dubai. Renting a <span style={{ fontWeight: 'bold' }}>{car.name} </span>in Dubai provides an opportunity to indulge in one of the most prestigious sports car brands ever created.<span className="br-margin"></span>
            The moment you step into a <span style={{ fontWeight: 'bold' }}>{car.name}</span>, you'll feel the rush of adrenaline. Choosing <span style={{ fontWeight: 'bold' }}>55 Car Rental LLC</span> in Dubai for your <span style={{ fontWeight: 'bold' }}>{car.name}</span> rental guarantees an unforgettable experience filled with luxury, power, and excitement. Renting this luxury supercar for a weekend getaway will allow you to appreciate every curve and detail of this car maker's engineering excellence. Don't wait any longer to leave your mark on the world; embark on an adventurous journey into the realm of luxury supercars today.<span className="br-margin"></span>
            Experience the dream of driving such an elegant beauty by renting a <span>{car.name}</span> in Dubai. We anticipate the powerful <span style={{ fontWeight: 'bold' }}>{car.name}</span> to be a common sight on the roads. We're here to make that dream come true for you, offering <span style={{ fontWeight: 'bold' }}>{car.name}</span> rentals in Dubai. Don't miss out <span>-</span> <span style={{ fontWeight: 'bold' }}>Book</span> your exotic <span style={{ fontWeight: 'bold' }}>{car.name}</span> rental in Dubai today.
          </p>
          <h2 style={{ marginTop: '4rem', marginBottom: '2rem', fontSize: '32px', marginLeft: '2rem' }}>
